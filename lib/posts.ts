...
export const POSTS: Post[] = [
  ...
  {
    id: 'p2', cat: '코스추천', pal: 'sage', featured: true,
  ...
  {
    id: 'p15', cat: '계절', pal: 'flower',
    title: '봄 진달래·철쭉 100대 명산 BEST — 개화 시기별 추천',
    excerpt: '4월 진달래부터 5월 철쭉까지, 봄꽃 피는 시기에 맞춘 100대 명산 코스 추천. 소요산·황매산·비슬산 개화 캘린더 정리.',
    body: `<h2>진달래 vs 철쭉 — 언제, 어디서 피나</h2><p>진달래와 철쭉은 피는 시기와 해발 고도가 다릅니다. 진달래는 잎이 나오기 전 꽃이 먼저 피는 낙엽관목으로 저지대에서 3월 말~4월 중순이 절정입니다. 철쭉은 잎과 꽃이 함께 나오는 상록관목으로 해발 1,000m 이상 고산에서 5월 중순~6월 초에 절정을 맞습니다. 봄꽃 산행은 이 두 가지 시기를 구분해 일정을 잡으면 4~6월 내내 꽃을 볼 수 있습니다.</p>
<h2>진달래 명산 BEST (4월)</h2>
<table style="width:100%;border-collapse:collapse;font-size:0.9em;margin:16px 0">
<thead><tr style="background:#ffe4e4"><th style="padding:8px;border:1px solid #f5c0c0;text-align:left">산</th><th style="padding:8px;border:1px solid #f5c0c0;text-align:left">위치</th><th style="padding:8px;border:1px solid #f5c0c0;text-align:left">절정 시기</th><th style="padding:8px;border:1px solid #f5c0c0;text-align:left">특이사항</th></tr></thead>
<tbody>
<tr><td style="padding:8px;border:1px solid #f5c0c0">소요산</td><td style="padding:8px;border:1px solid #f5c0c0">경기 동두천</td><td style="padding:8px;border:1px solid #f5c0c0">4월 초~중순</td><td style="padding:8px;border:1px solid #f5c0c0">경원선 소요산역 도보 5분</td></tr>
<tr style="background:#fff5f5"><td style="padding:8px;border:1px solid #f5c0c0">천마산</td><td style="padding:8px;border:1px solid #f5c0c0">경기 마석</td><td style="padding:8px;border:1px solid #f5c0c0">4월 중순</td><td style="padding:8px;border:1px solid #f5c0c0">진달래 군락 대규모</td></tr>
<tr><td style="padding:8px;border:1px solid #f5c0c0">비슬산</td><td style="padding:8px;border:1px solid #f5c0c0">경북 달성</td><td style="padding:8px;border:1px solid #f5c0c0">4월 중순~하순</td><td style="padding:8px;border:1px solid #f5c0c0">참꽃군락지 1,000m 이상</td></tr>
<tr style="background:#fff5f5"><td style="padding:8px;border:1px solid #f5c0c0">황매산</td><td style="padding:8px;border:1px solid #f5c0c0">경남 합천</td><td style="padding:8px;border:1px solid #f5c0c0">4월 하순~5월 초</td><td style="padding:8px;border:1px solid #f5c0c0">철쭉과 진달래 동시 관찰 가능</td></tr>
</tbody></table>
<h2>철쭉 명산 BEST (5월)</h2>
<table style="width:100%;border-collapse:collapse;font-size:0.9em;margin:16px 0">
<thead><tr style="background:#ffe4e4"><th style="padding:8px;border:1px solid #f5c0c0;text-align:left">산</th><th style="padding:8px;border:1px solid #f5c0c0;text-align:left">위치</th><th style="padding:8px;border:1px solid #f5c0c0;text-align:left">절정 시기</th><th style="padding:8px;border:1px solid #f5c0c0;text-align:left">특이사항</th></tr></thead>
<tbody>
<tr><td style="padding:8px;border:1px solid #f5c0c0">지리산 바래봉</td><td style="padding:8px;border:1px solid #f5c0c0">전북 남원</td><td style="padding:8px;border:1px solid #f5c0c0">5월 초~중순</td><td style="padding:8px;border:1px solid #f5c0c0">국내 최대 철쭉 군락</td></tr>
<tr style="background:#fff5f5"><td style="padding:8px;border:1px solid #f5c0c0">황매산 황매평전</td><td style="padding:8px;border:1px solid #f5c0c0">경남 합천</td><td style="padding:8px;border:1px solid #f5c0c0">5월 초~중순</td><td style="padding:8px;border:1px solid #f5c0c0">드라이브+산행 가능</td></tr>
<tr><td style="padding:8px;border:1px solid #f5c0c0">소백산 비로봉</td><td style="padding:8px;border:1px solid #f5c0c0">충북 단양</td><td style="padding:8px;border:1px solid #f5c0c0">5월 중순~하순</td><td style="padding:8px;border:1px solid #f5c0c0">비로봉~국망봉 능선 철쭉</td></tr>
<tr style="background:#fff5f5"><td style="padding:8px;border:1px solid #f5c0c0">덕유산 향적봉</td><td style="padding:8px;border:1px solid #f5c0c0">전북 무주</td><td style="padding:8px;border:1px solid #f5c0c0">5월 하순~6월 초</td><td style="padding:8px;border:1px solid #f5c0c0">곤돌라+철쭉 조합</td></tr>
</tbody></table>
<h2>봄 산행 시 주의사항</h2>
<p>3~5월은 산불 조심 기간입니다. 입산 통제 구역이 확대되는 경우가 많으니 출발 전 산림청 산불예방 통제정보를 반드시 확인하세요. 봄꽃 절정기는 탐방객이 급증하는 시기로 주요 명산 주차장은 토요일 오전 7시 전후로 만차가 됩니다. 대중교통을 이용하거나 평일 산행을 권장합니다.</p>
<p>봄꽃 개화 현황은 국립공원 공식 SNS와 지자체 산림 부서에서 매주 업데이트합니다. 출발 전날 실시간 개화 상태를 확인하면 절정 타이밍을 놓치지 않습니다.</p>
<p>봄 산행 이후 계절별 산행 계획을 이어가고 싶다면 <a href="/blog/p9">단풍 절정 시기로 고른 가을 명산 지도</a>에서 가을 일정도 미리 잡아두세요.</p>
<div class="safety"><strong>산행 전 반드시 확인하세요</strong><p>봄철 산불 조심 기간 입산 통제 현황은 산림청 공식 웹사이트에서 확인하세요. 통제 구역 진입 시 과태료가 부과됩니다.</p></div>`,
    read: 7, date: '2026.04.22',
    badges: ['봄', '진달래', '철쭉'],
  },
  {
    id: 'p16', cat: '안전', pal: 'dawn',
    title: '산에서 길을 잃었을 때 — 5가지 대처법과 위치 전달 요령',
    excerpt: '지도가 없어도, 신호가 약해도 당황하지 않는 법. 조난 초기 5분 행동이 구조 시간을 2~3시간 앞당깁니다.',
    body: `<h2>조난 초기 5분이 결정한다</h2><p>산에서 길을 잃으면 패닉이 오고, 패닉 상태에서 빠르게 이동하다가 더 깊이 들어가는 것이 조난 사고를 악화시키는 가장 흔한 패턴입니다. 길을 잃었다는 것을 인식한 순간 가장 먼저 해야 할 일은 멈추는 것입니다. 그 자리에서 3분간 주변을 살피고, 온 길을 기억하며 되짚을 수 있는지 판단합니다. 계속 움직이면 구조대가 마지막 위치에서 추적하는 시간이 늘어납니다.</p>
<h2>5가지 대처법</h2>
<ol>
<li style="margin-bottom:12px"><strong>STOP 원칙 — 멈추고, 생각하고, 관찰하고, 계획한다</strong><br>Stop(멈춤) → Think(상황 파악) → Observe(주변 관찰) → Plan(행동 계획). 패닉 상태에서의 무작위 이동이 가장 위험합니다.</li>
<li style="margin-bottom:12px"><strong>왔던 길로 되돌아간다</strong><br>마지막으로 확신했던 지점까지 되돌아가는 것이 원칙입니다. 새로운 길을 개척하려 하지 마세요. 지도에 없는 샛길은 더 깊은 곳으로 이어질 수 있습니다.</li>
<li style="margin-bottom:12px"><strong>위치 표지판을 찾는다</strong><br>국립공원과 도립공원 탐방로에는 일정 간격으로 위치 표지판이 설치돼 있습니다. '북한산 03-05'처럼 구간 코드가 적혀 있으며, 이 코드를 119에 알리면 위치 파악이 빠릅니다.</li>
<li style="margin-bottom:12px"><strong>119에 먼저 신고하고 현재 위치를 공유한다</strong><br>완전히 길을 잃기 전, 불안이 시작되는 단계에서 먼저 신고하는 것이 최선입니다. GPS 좌표는 산림청 숲길 앱(무료)에서 현재 위치 확인 기능으로 조회할 수 있습니다. 신호가 약할 때는 문자 신고(119)도 가능합니다.</li>
<li style="margin-bottom:12px"><strong>야간이 되기 전에 행동을 완료한다</strong><br>일몰 1시간 전이 지나면 구조 헬기 운용이 제한됩니다. 해가 지기 전에 위치를 알리고 구조를 기다리거나, 안전한 곳에서 비박할 준비를 해야 합니다.</li>
</ol>
<h2>위치를 정확히 전달하는 3가지 방법</h2>
<ul>
<li><strong>위치 표지판 코드</strong>: 탐방로의 표지판 코드를 119에 알립니다. 가장 정확합니다.</li>
<li><strong>GPS 좌표</strong>: 산림청 숲길 앱 또는 카카오맵에서 현재 좌표를 확인합니다.</li>
<li><strong>주변 지형 묘사</strong>: "계곡이 왼쪽에 있고, 정상이 오른쪽 위에 보임" 처럼 주변을 묘사합니다.</li>
</ul>
<h2>자주 묻는 질문</h2>
<details open><summary><strong>스마트폰 배터리가 거의 없을 때 어떻게 해야 하나요?</strong></summary><p>신호가 있는 상태라면 먼저 119에 신고하고, 신고 후 저전력 모드로 전환합니다. 배터리 절약을 위해 화면 밝기를 최소로 낮추고 Wi-Fi·블루투스를 끕니다. 보조배터리를 항상 챙기는 것이 가장 좋은 예방책입니다.</p></details>
<details><summary><strong>산에서 신호가 전혀 안 잡힐 때는요?</strong></summary><p>능선 방향으로 이동하면 신호가 잡히는 경우가 많습니다. 계곡 바닥은 신호가 가장 약합니다. LTE 신호가 없어도 119 긴급문자는 별도 채널로 전송되는 경우가 있습니다.</p></details>
<div class="safety"><strong>산행 전 반드시 확인하세요</strong><p>출발 전 지인에게 목적지·코스·예상 귀가시간을 알려두세요. 조난 시 최초 신고가 빠를수록 구조 시간이 단축됩니다.</p></div>`,
    read: 6, date: '2026.04.18',
    badges: ['안전', '조난'],
  },
  {
    id: 'p17', cat: '장비', pal: 'sage',
    title: '등산 양말 고르는 법 — 물집 예방과 소재 비교',
    excerpt: '울 양말과 합성 양말의 차이, 두께 선택 기준, 물집이 생기는 근본 원인을 데이터로 풀었습니다.',
    body: `<h2>등산 양말이 중요한 이유</h2><p>등산 사고 통계를 보면 발 관련 부상(물집·발목 염좌·발가락 압박)이 전체 부상의 15~20%를 차지합니다. 대부분은 양말이 아닌 등산화 문제처럼 보이지만, 같은 등산화라도 양말이 달라지면 결과가 달라지는 경우가 많습니다. 마찰력이 낮은 양말은 발이 등산화 안에서 미끄러져 물집을 만들고, 흡습이 안 되는 양말은 땀이 고여 균류 감염을 유발합니다.</p>
<h2>소재별 비교</h2>
<table style="width:100%;border-collapse:collapse;font-size:0.9em;margin:16px 0">
<thead><tr style="background:#e7eee6"><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">소재</th><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">흡습</th><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">보온</th><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">내구성</th><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">적합 계절</th></tr></thead>
<tbody>
<tr><td style="padding:8px;border:1px solid #b0c8a8">메리노 울</td><td style="padding:8px;border:1px solid #b0c8a8">우수</td><td style="padding:8px;border:1px solid #b0c8a8">높음</td><td style="padding:8px;border:1px solid #b0c8a8">보통</td><td style="padding:8px;border:1px solid #b0c8a8">봄·가을·겨울</td></tr>
<tr style="background:#f5f9f4"><td style="padding:8px;border:1px solid #b0c8a8">합성(폴리·나일론)</td><td style="padding:8px;border:1px solid #b0c8a8">빠른 건조</td><td style="padding:8px;border:1px solid #b0c8a8">낮음</td><td style="padding:8px;border:1px solid #b0c8a8">높음</td><td style="padding:8px;border:1px solid #b0c8a8">여름·장거리</td></tr>
<tr><td style="padding:8px;border:1px solid #b0c8a8">울+합성 혼방</td><td style="padding:8px;border:1px solid #b0c8a8">우수</td><td style="padding:8px;border:1px solid #b0c8a8">중간</td><td style="padding:8px;border:1px solid #b0c8a8">높음</td><td style="padding:8px;border:1px solid #b0c8a8">사계절 범용</td></tr>
<tr style="background:#f5f9f4"><td style="padding:8px;border:1px solid #b0c8a8">면</td><td style="padding:8px;border:1px solid #b0c8a8">낮음</td><td style="padding:8px;border:1px solid #b0c8a8">중간</td><td style="padding:8px;border:1px solid #b0c8a8">높음</td><td style="padding:8px;border:1px solid #b0c8a8">산행 비권장</td></tr>
</tbody></table>
<h2>두께 선택 기준</h2>
<p>등산 양말 두께는 라이트웨이트(여름·저지대)·미드웨이트(사계절 범용)·헤비웨이트(겨울·고산) 세 종류로 나뉩니다. 등산화 사이즈를 살 때 두꺼운 양말을 신고 측정해야 한다는 것이 중요합니다. 여름용 얇은 양말을 신고 산 등산화를 겨울에 두꺼운 양말 신고 신으면 발가락이 짓눌립니다.</p>
<h2>물집 예방 실전 팁</h2>
<ul>
<li><strong>이중 양말 시스템</strong>: 얇은 라이너 양말 위에 등산 양말을 겹쳐 신으면 양말 간 마찰이 발과 양말 간 마찰 대신 발생해 물집을 줄여줍니다.</li>
<li><strong>발 건조 유지</strong>: 계곡을 건넌 후 젖은 양말을 반드시 교체하세요. 습한 환경은 물집 발생 확률을 3배 높입니다.</li>
<li><strong>압박 구간 테이핑</strong>: 발가락 마찰이 잦은 부위는 출발 전 의료용 테이프로 보호합니다. 발뒤꿈치·엄지발가락 옆면이 주요 취약 부위입니다.</li>
</ul>
<p>등산화와 양말의 궁합은 <a href="/blog/p12">등산화 고르는 법</a>에서 착화 기준과 함께 확인할 수 있습니다. 장거리 산행에서 발 관리는 <a href="/blog/p8">배낭 무게 줄이는 패킹 체크리스트</a>와 함께 챙기면 완성도가 높아집니다.</p>
<div class="safety"><strong>산행 전 반드시 확인하세요</strong><p>발 부상이 이미 있는 경우 산행을 강행하지 마세요. 부상 악화로 인한 구조 요청 사례가 매년 발생합니다.</p></div>`,
    read: 6, date: '2026.04.16',
    badges: ['장비', '양말', '물집'],
  },
  ...
  // ── 가이드 ──────────────────────────────────────────────
  {
    ...
    body: `<h2>100대 명산이란?</h2><p>산림청이 2002년 선정한 한국의 대표 명산 100곳입니다. 경관·역사·문화적 가치를 기준으로 선정됐으며, 전국 각 지역에 고르게 분포해 있습니다. 완등에 특별한 자격이나 등록은 필요 없습니다. 자신의 페이스로 하나씩 오르면 됩니다.</p>
<h2>처음 산을 고르는 기준</h2>
<table style="width:100%;border-collapse:collapse;font-size:0.9em;margin:16px 0">
<thead><tr style="background:#e7eee6"><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">기준</th><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">초보 기준값</th><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">이유</th></tr></thead>
<tbody>
<tr><td style="padding:8px;border:1px solid #b0c8a8">표고차</td><td style="padding:8px;border:1px solid #b0c8a8">400m 이하</td><td style="padding:8px;border:1px solid #b0c8a8">대퇴사두근 과부하 방지</td></tr>
<tr style="background:#f5f9f4"><td style="padding:8px;border:1px solid #b0c8a8">편도 거리</td><td style="padding:8px;border:1px solid #b0c8a8">4km 이하</td><td style="padding:8px;border:1px solid #b0c8a8">왕복 4시간 이내 완료</td></tr>
<tr><td style="padding:8px;border:1px solid #b0c8a8">탐방로</td><td style="padding:8px;border:1px solid #b0c8a8">정비된 흙길</td><td style="padding:8px;border:1px solid #b0c8a8">암릉 구간 회피</td></tr>
<tr style="background:#f5f9f4"><td style="padding:8px;border:1px solid #b0c8a8">대중교통</td><td style="padding:8px;border:1px solid #b0c8a8">가능 권장</td><td style="padding:8px;border:1px solid #b0c8a8">주차 스트레스 없이 집중</td></tr>
</tbody></table>
<h2>난이도 순서 짜기</h2><p>처음 3~5개는 '난이도 하' 산으로 시작합니다. 관악산·청계산·계룡산·천마산·용문산이 입문에 적합합니다. 10개를 마친 후 '난이도 중' 산에 도전하고, 20개 이상에서 '난이도 상' 산을 고르는 게 일반적인 순서입니다. 고산(1,400m 이상)은 체력이 충분히 쌓인 후 도전하세요.</p>
<h2>자주 묻는 질문</h2>
<details open><summary><strong>100대 명산 완등 인증을 받을 수 있나요?</strong></summary><p>한국산악회, 블랙야크 등 민간 단체에서 인증 프로그램을 운영합니다. 각 단체 홈페이지를 통해 신청할 수 있으며, 정상 인증샷이나 인증 스탬프가 필요합니다.</p></details>
<details><summary><strong>100대 명산을 다 오르는 데 얼마나 걸리나요?</strong></summary><p>개인 페이스에 따라 다릅니다. 연간 10~20개씩 오른다면 5~10년 내에 완등이 가능합니다. 매주 1회 꾸준히 산행하는 분들은 3~5년에 완주하기도 합니다.</p></details>
<p>첫 산 선택에서 더 구체적인 목록이 필요하다면 <a href="/blog/p2">초보가 처음 오르기 좋은 100대 명산 10</a>을 참고하세요. 대중교통으로 접근 가능한 목록은 <a href="/blog/p11">대중교통으로 갈 수 있는 100대 명산 TOP 15</a>에서 확인할 수 있습니다.</p>
<div class="safety"><strong>산행 전 반드시 확인하세요</strong><p>출발 전 산림청·국립공원 공식 통제정보와 기상청 산악날씨를 확인하세요.</p></div>`,
  ...
  },
  {
    ...
    body: `<h2>왜 산악 날씨 전용 앱이 필요한가</h2><p>일반 날씨 앱의 예보는 해당 지역 평지 기상 관측소 데이터를 기반으로 합니다. 해발 1,000m 이상 고산은 평지와 기온 차이가 5~8도, 풍속 차이가 초속 3~5m 이상 날 수 있습니다. 정상부에서 강우가 예보되지 않았는데 갑자기 비가 내리는 경우의 대부분은 이 고도 차이를 무시한 예보를 믿었기 때문입니다.</p>
<h2>앱별 비교</h2>
<table style="width:100%;border-collapse:collapse;font-size:0.9em;margin:16px 0">
<thead><tr style="background:#e7eee6"><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">항목</th><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">기상청 산악날씨</th><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">윈디(Windy)</th><th style="padding:8px;border:1px solid #b0c8a8;text-align:left">날씨온</th></tr></thead>
<tbody>
<tr><td style="padding:8px;border:1px solid #b0c8a8">정확도</td><td style="padding:8px;border:1px solid #b0c8a8">한국 산악 최적화</td><td style="padding:8px;border:1px solid #b0c8a8">고도별 모델 우수</td><td style="padding:8px;border:1px solid #b0c8a8">일반 예보 수준</td></tr>
<tr style="background:#f5f9f4"><td style="padding:8px;border:1px solid #b0c8a8">풍속·방향</td><td style="padding:8px;border:1px solid #b0c8a8">시간별 제공</td><td style="padding:8px;border:1px solid #b0c8a8">시각화 탁월</td><td style="padding:8px;border:1px solid #b0c8a8">기본 수준</td></tr>
<tr><td style="padding:8px;border:1px solid #b0c8a8">강수 확률</td><td style="padding:8px;border:1px solid #b0c8a8">6시간 단위</td><td style="padding:8px;border:1px solid #b0c8a8">1시간 단위</td><td style="padding:8px;border:1px solid #b0c8a8">3시간 단위</td></tr>
<tr style="background:#f5f9f4"><td style="padding:8px;border:1px solid #b0c8a8">무료 여부</td><td style="padding:8px;border:1px solid #b0c8a8">완전 무료</td><td style="padding:8px;border:1px solid #b0c8a8">기본 무료</td><td style="padding:8px;border:1px solid #b0c8a8">완전 무료</td></tr>
<tr><td style="padding:8px;border:1px solid #b0c8a8">오프라인</td><td style="padding:8px;border:1px solid #b0c8a8">불가</td><td style="padding:8px;border:1px solid #b0c8a8">불가</td><td style="padding:8px;border:1px solid #b0c8a8">불가</td></tr>
</tbody></table>
<h2>기상청 산악날씨 사용법</h2><p>weather.go.kr에서 상단 메뉴 "날씨" → "산악날씨"로 진입합니다. 산 이름으로 검색하면 해당 산의 주요 지점(산아래·중간·정상)별로 기온·풍속·강수 예보를 3일치 볼 수 있습니다. 정상부 풍속이 초속 7m 이상이면 체감온도 급락과 균형 문제가 생기므로 산행 재고를 권장합니다.</p>
<h2>윈디 사용 팁</h2><p>windy.com 또는 앱에서 원하는 좌표를 찍으면 ECMWF·GFS 등 복수 모델 비교가 가능합니다. 고도별(해발 925/850/500hPa) 기상 조회 기능이 강점입니다. 예보 모델이 일치하면 신뢰도가 높고, 모델 간 차이가 크면 기상이 불안정하다는 신호입니다.</p>
<p>산행 전 날씨 확인 루틴 전체는 <a href="/blog/p5">산행 전 반드시 확인하는 통제·기상 정보 5곳</a>을 참고하세요. 계절별 산행 준비는 <a href="/blog/p15">봄 진달래·철쭉 100대 명산 BEST</a>에서 이어집니다.</p>
<div class="safety"><strong>산행 전 반드시 확인하세요</strong><p>기상 예보는 참고 자료입니다. 현장 기상 변화에 따라 즉각 판단하고, 위험 기상 시 하산을 우선하세요.</p></div>`,
  ...
  // ── 추가 포스트 p21~p40 ─────────────────────────────────
  {
    ...
    body: `<h2>성판악 vs 관음사 코스 비교표</h2><table><thead><tr><th>항목</th><th>성판악 코스</th><th>관음사 코스</th></tr></thead><tbody><tr><td>편도 거리</td><td>9.6km</td><td>8.7km</td></tr><tr><td>편도 소요</td><td>4시간 30분</td><td>5시간</td></tr><tr><td>고도 상승</td><td>1,341m</td><td>1,406m</td></tr><tr><td>난이도</td><td>중</td><td>상</td></tr><tr><td>특징</td><td>탐방 인원 가장 많음, 숲길 위주</td><td>계곡·암릉, 경관 우수</td></tr></tbody></table><p>성판악 코스는 한라산 탐방로 중 가장 많은 탐방객이 이용합니다. 5.16도로 성판악 탐방지원센터(해발 750m)에서 출발해 사라오름 분기점·진달래밭 대피소를 거쳐 백록담(1,950m)에 이르는 9.6km 루트입니다. 경사가 비교적 완만하고 숲길이 이어져 처음 한라산을 오르는 탐방객에게 적합합니다.</p><h2>탐방예약제 — 성판악 예약 방법</h2><p>한라산 탐방예약제는 성판악·관음사 코스 진입 시 사전 예약이 의무입니다. 국립공원공단 예약 시스템(reservation.knps.or.kr)에서 탐방 희망일 기준 한 달 전부터 예약 가능합니다. 탐방 허가 인원은 성판악 1,000명/일, 관음사 500명/일로 제한됩니다. 성수기(봄·가을 주말)에는 수분~수 시간 내에 예약이 마감되므로 잔여 예약 오픈 날짜(취소분 재오픈)를 주기적으로 확인하는 것이 실용적입니다.</p><h2>구간별 소요시간과 핵심 체크포인트</h2><ul><li><strong>성판악 탐방지원센터(750m)</strong> → <strong>속밭 대피소(1,350m)</strong>: 약 1시간 40분. 완만한 편백림 구간.</li><li><strong>속밭 대피소</strong> → <strong>사라오름 분기점(1,590m)</strong>: 약 30분. 사라오름 왕복 추가 시 30분.</li><li><strong>사라오름 분기점</strong> → <strong>진달래밭 대피소(1,700m)</strong>: 약 30분. 정상 입산 통제 시간 확인 지점.</li><li><strong>진달래밭 대피소</strong> → <strong>백록담 정상(1,950m)</strong>: 약 1시간 30분. 경사 급증 구간.</li></ul><p>진달래밭 대피소는 정상 입산 통제 기준 시간(12시·13시 교대 적용)을 확인하는 마지막 지점입니다. 이 시간 이후에는 정상 방향 통행이 차단되므로, 오전 6시~7시 출발이 정상 완주의 필수 조건입니다.</p><h2>자주 묻는 질문</h2><details open><summary><strong>한라산 성판악 코스 예약 없이 오를 수 있나요?</strong></summary><p>성판악·관음사 코스는 탐방예약제가 적용되어 사전 예약 없이 입장이 불가합니다. 어리목·영실 코스는 예약 없이 탐방이 가능하며 백록담까지는 연결되지 않습니다.</p></details><details><summary><strong>성판악 코스 화장실이 있나요?</strong></summary><p>성판악 탐방지원센터, 속밭 대피소, 진달래밭 대피소에 화장실이 있습니다. 정상 인근에는 화장실이 없으므로 진달래밭 대피소에서 반드시 이용하세요.</p></details><p>겨울 한라산 설경과 아이젠 착용 기준은 <a href="/blog/p3">겨울 눈꽃 산행 아이젠·스패츠 고르는 법</a>을 참고하세요. 한라산 입산 전 기상 확인은 <a href="/blog/p5">산행 전 반드시 확인하는 통제·기상 정보 5곳</a>을 이용하세요.</p><div class="safety"><strong>산행 전 반드시 확인하세요</strong><p>탐방예약 미보유 시 입장 불가합니다. 국립공원공단 공식 앱 또는 reservation.knps.or.kr에서 예약 후 출발하세요.</p></div>`,
